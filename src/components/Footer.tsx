        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm">
              ...
              <li><Link to="/contact" className="hover:text-nextstep-blue">Contact</Link></li>
              <li><Link to="/privacy" className="hover:text-nextstep-blue">Privacy Policy</Link></li>
              <li><Link to="/terms" className="hover:text-nextstep-blue">Terms of Service</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm">
              <li>Email: info@nextstep.edu</li>
              <li>Phone: +91 123 456 7890</li>
              <li className="pt-4">
                <div className="flex space-x-4">
                  <a href="#" className="text-gray-500 hover:text-nextstep-blue">
